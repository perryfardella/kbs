...
const SEED_TRANSACTIONS: SeedTransaction[] = [
  ...
  { date: "2025-04-25", amount: 210.00, description: "BC Hydro — electricity bill", type: "personal_expense" },
  { date: "2025-05-02", amount: 118.75, description: "Superstore — groceries", type: "personal_expense", categoryName: "Groceries" },
  { date: "2025-05-09", amount: 16.99, description: "Netflix — monthly subscription", type: "personal_expense" },
  ...
  { date: "2025-06-14", amount: 220.00, description: "TELUS — home internet & phone", type: "personal_expense" },
  ...
  { date: "2025-10-18", amount: 18.99, description: "Spotify — family plan", type: "personal_expense" },
  ...
  { date: "2025-12-20", amount: 220.00, description: "BC Hydro — electricity bill", type: "personal_expense" },
  ...
  { date: "2025-04-22", amount: 49.00, description: "Jane App — EMR monthly subscription", type: "business_expense" },
  ...
  { date: "2025-05-28", amount: 49.00, description: "Jane App — EMR monthly subscription", type: "business_expense" },
  ...
  { date: "2025-06-08", amount: 45.00, description: "Spotify — personal subscription (corp account)", type: "personal_expense_business_pay" },
  ...
  { date: "2025-10-10", amount: 54.20, description: "Gas — personal vehicle (corp card)", type: "personal_expense_business_pay" },
  ...
  { date: "2026-02-06", amount: 38.00, description: "Netflix — personal subscription (corp account)", type: "personal_expense_business_pay" },
